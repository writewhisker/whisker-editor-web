...
import type { ThreadStepResult } from './runtime-types';
...
describe('Container', () => {
  describe('initialization', () => {
    ...
    it('should throw when accessing disabled features', () => {
      const container = new Container({ enableThreads: false });
  ...
  describe('factory functions', () => {
    it('createContainer should create container with options', () => {
      const container = createContainer({ enableTimers: false });
