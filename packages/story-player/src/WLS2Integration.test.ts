...
import { WLS2Integration, createWLS2Player, createTestWLS2Player } from './WLS2Integration';
...
describe('WLS2Integration', () => {
  let integration: WLS2Integration;

  beforeEach(() => {
    integration = createTestWLS2Player();
  });
  ...
  describe('Construction', () => {
    ...
    it('should disable timing when specified', () => {
      const player = new WLS2Integration({ enableTiming: false });
      expect(player.getTimedContentManager()).toBeNull();
    });

    it('should disable effects when specified', () => {
      const player = new WLS2Integration({ enableEffects: false });
  ...
  describe('Factory Functions', () => {
    it('should create player with createWLS2Player', () => {
      const player = createWLS2Player();
      expect(player).toBeInstanceOf(WLS2Integration);
    });

    it('should create player with createWLS2Player and config', () => {
      const player = createWLS2Player({
    ...
    it('should create test player with createTestWLS2Player', () => {
      const player = createTestWLS2Player();
      expect(player).toBeInstanceOf(WLS2Integration);
