/**
 * Tests for AIPromptTemplates component
 * 
...
describe('AIPromptTemplates - Core Functionality', () => {
...
describe('AIPromptTemplates - Data Validation', () => {
...
describe('AIPromptTemplates - Edge Cases', () => {
