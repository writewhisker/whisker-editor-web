                ...
                <div class="flex items-center justify-between mb-2">
                  <label class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100">
                      {slot.type === 'manual' ? '💾' : slot.type === 'auto' ? '⚡' : '⚡'}
                      {slot.label}
                    </span>
                  </label>
                </div>
        ...
        <div class="border border-gray-200 dark:border-gray-700 rounded">
          <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400"
            >
              {copiedSection === 'save' ? '✓ Copied!' : '📋 Copy'}
            </button>
          </div>
        ...
        <div class="border border-gray-200 dark:border-gray-700 rounded">
          <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400"
            >
              {copiedSection === 'load' ? '✓ Copied!' : '📋 Copy'}
            </button>
          </div>
        ...
        <div class="border border-gray-200 dark:border-gray-700 rounded">
          <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              ...
              class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400"
            >
              {copiedSection === 'delete' ? '✓ Copied!' : '📋 Copy'}
            </button>
          </div>
          ...
          <div class="border border-gray-200 dark:border-gray-700 rounded">
            <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400"
              >
                {copiedSection === 'utilities' ? '✓ Copied!' : '📋 Copy'}
              </button>
            </div>
